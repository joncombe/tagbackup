...
- **Refresh** — click Refresh to re-list the selected bucket from S3 without reloading the page. Useful when files were added or removed outside the UI while `serve` is running.
